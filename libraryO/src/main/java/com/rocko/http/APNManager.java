...
public class APNManager {
    ...
    public int isApnExisted(APN apnNode) {
        ...
        while (mCursor != null && mCursor.moveToNext()) {
            ...
            Log.e("isApnExisted", "info:" + apnId + "_" + name + "_" + apn + "_" + type + "_" + current + "_"
                    + proxy);// 遍历了所有的apn
            if (/* apnNode.getName().equals(name) */(apnNode.getApn().equals(apn)
                    && apnNode.getMcc().equals(mcc) && apnNode.getMnc().equals(mnc) && apnNode.getNumeric()
                    .equals(numeric)) && (type == null || "default".equals(type) || "".equals(type)))// ||
    ...
    public boolean setDefaultApn(int apnId) {
        ...
        try {
            ...
            Cursor c = resolver.query(PREFERRED_APN_URI, new String[]{"name", "apn"}, "_id=" + apnId,
                    null, null);
            if (c != null) {
                res = true;
                c.close();
    ...
    public APN getDefaultAPN() {
        ...
        String numeric = "";
        APN apnNode = new APN();
        Cursor mCursor = resolver.query(PREFERRED_APN_URI, null, null, null, null);
        if (mCursor == null) {
        ...
        while (mCursor != null && mCursor.moveToNext()) {
            ...
            Log.d("getDefaultAPN", "default Apn info:" + id + "_" + name + "_" + apn + "_" + proxy + "_"
                    + proxy);
