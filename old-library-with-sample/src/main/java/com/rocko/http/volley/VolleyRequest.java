...
import com.rocko.app.MainApplication;
...
public class VolleyRequest {
    private static final VolleyRequest volleyRequestQueue = new VolleyRequest(MainApplication.getContext());
    ...
    private VolleyRequest(Context context) {
        mRequestQueue = Volley.newRequestQueue(context, new HttpClientStack(
                CustomHttpClient.getHttpClient(context)));
