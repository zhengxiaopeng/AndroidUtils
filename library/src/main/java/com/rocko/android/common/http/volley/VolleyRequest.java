package com.rocko.android.common.http.volley;
...
public final class VolleyRequest {
    private static final VolleyRequest volleyRequestQueue = new VolleyRequest(ACApplication.getContext());
     ...
     * @return
     */
    public ImageRequest newImageRequest(String url, Listener<Bitmap> listener, int maxWidth,
