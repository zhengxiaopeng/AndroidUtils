...
public class SharedPreferencesManager {
	 ...
	 *            sp的文件名
	 */
	public SharedPreferencesManager(String spFileName) {
		this(spFileName, Context.MODE_PRIVATE);
	}
	 ...
	 *            模式
	 */
	public SharedPreferencesManager(String spFileName, int mode) {
		sp = MainApplication.getContext().getSharedPreferences(spFileName, mode);
		editor = sp.edit();
	}
